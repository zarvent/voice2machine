...
echo "gh pr create \\"
echo "  --base main \\"
echo "  --head nueva-interfaz \\"
echo "  --title \"feat: Implementar GUI con Tauri + React para voice2machine\" \\"
echo "  --body-file PR_NUEVA_INTERFAZ.md \\"
echo "  --assignee @me"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "5. Agrega labels: 'enhancement', 'frontend', 'documentation'"
echo ""
...
if command -v gh &> /dev/null; then
    ...
    if [[ $REPLY =~ ^[Yy]$ ]]; then
        ...
        gh pr create \
          --base main \
          --head nueva-interfaz \
          --title "feat: Implementar GUI con Tauri + React para voice2machine" \
          --body-file PR_NUEVA_INTERFAZ.md \
          --assignee @me \
          --label enhancement,frontend,documentation
