...
*   `entidades`: objetos que tienen una identidad única que persiste a lo largo del tiempo (e.g., `transcripcion`).
*   `objetos de valor`: objetos inmutables definidos por sus atributos, sin una identidad conceptual (e.g., `segmento_de_audio`).
