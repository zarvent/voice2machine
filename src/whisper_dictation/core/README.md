...
*   `abstracciones base`: clases e interfaces fundamentales que definen contratos genéricos utilizados en toda la aplicación (e.g., `command_handler`).
...
*   **¿puedo añadir librerías externas aquí?**
    *   sí, pero deben ser librerías de propósito general que actúen como herramientas fundamentales (e.g., una librería para inyección de dependencias).
